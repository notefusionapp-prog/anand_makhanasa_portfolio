  ...
  return (
    <div className="pt-28 pb-20 min-h-screen bg-[#fbfdff] dark:bg-[#070d1e] text-[#0B1B3D] dark:text-slate-100 transition-colors duration-300">
      <SEOHead 
        ...
        description="Learn about Anand Makhanasa, Senior Flutter Developer with 2.5+ years building production Android & iOS apps with 11+ published applications on Google Play."
        canonicalPath="/about"
        ogType="profile"
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
            ...
            <div className="lg:col-span-8 space-y-4 text-left">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 pt-2">
                ...
                <div className="p-3 rounded-2xl bg-slate-50 dark:bg-[#070d1e]/60 border border-slate-200/80 dark:border-slate-800">
                  <div className="text-xl font-black text-emerald-600 dark:text-emerald-400">11+</div>
              ...
              <div className="flex flex-wrap items-center gap-3 pt-4">
                ...
                >
                  ...
                  <span>View 11+ Published Apps</span>
